...
model_names = ["LSTM_HiCap_LowNoise",
               "LSTM_HiCap_mediumNoise",
               "LSTM_HiCap_highNoise"]
...
fig_ptm.savefig(f"./figures/{VA_type}/percent_macroHC.png")
fig_CVaR.savefig(f"./figures/{VA_type}/CVaR_macroHC.png")

print(df_MSE)
df_MSE.to_csv(f"./figures/{VA_type}/MSE_macroHC.csv")
