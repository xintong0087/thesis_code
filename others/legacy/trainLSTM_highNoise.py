...
# LoCap LSTM, highNoise GMWB Datasets
...
save_name = "LSTM_LoCap_highNoise"

for rep in range(n_rep):
    loss_file = lossFiles_highNoise[rep]
...
# HiCap LSTM, highNoise GMWB Datasets
model_name = "LSTM"
recurrent_layer_size = [128, 16]
dense_layer_size = 64

save_name = "LSTM_HiCap_highNoise"
