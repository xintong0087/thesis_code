...
# Load models
save_path_LSTM = save_path + "NTuning_L/"

model_trained_LSTM_100 = tf.keras.models.load_model(save_path + "LSTM_128-16_tanh/trained_model")
...
save_path_figures = "./figures/NTuning_LSTM3/"
...
def cal_CVaR(cwd, models, model_names, X_list, y_true_list, y_mean_list, y_std_list):
    ...
    fig_CVaR.savefig(cwd + "LSTM_HiCap_CVaR_lower.png")
    ...
    fig_CVaR_2.savefig(cwd + "LSTM_HiCap_CVaR_higher.png")
...
#                         [y_true_001, y_true_010, y_true_100, y_true_10000], lim_tail=(0.35, 1.0), lim_QQ=(-450, 800),
#                         scale_flag=True, 
...
#                         [y_true_001, y_true_010, y_true_100], lim_tail=(0.35, 1.0), lim_QQ=(-450, 800),
#                         scale_flag=True, 
